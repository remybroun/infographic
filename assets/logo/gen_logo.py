...
def lockup_svg(scheme="light"):
  ...
  <text class="tag" x="276" y="176">a claude code skill</text>
</svg>
'''
  ...
  <div class="plate light">
    <div style="display:flex; align-items:center; gap:36px;">
      ...
      <div>
        ...
        <div style="font-size:14px; letter-spacing:0.14em; text-transform:uppercase; color:var(--warm); margin-top:10px;">a claude code skill</div>
      </div>
    </div>
  </div>
