...
def diagram():
    ...
    return page(
        ...
        {"type": "swimlane", "span": 12, "frame": "card",
         "title": "The pipeline, and who performs each step",
         "stages": ["Source", "Reader", "Brief", "Scenes", "Forms", "Check",
                    "Draw", "Spec", "Render", "Look", "Hand off"],
         "lanes": [
             {"label": "You", "cells": ["Read it", "Name them", "Open it", "Rank three",
                                        "One each", None, None, None, None,
                                        "Judge it", None]},
             {"label": "Tooling", "cells": ["extract", None, None, None, None,
                                            "brief", "order", "new", "render",
                                            "shoot", "handoff"]}],
         "note": "Steps two to six cannot be automated. They are the skill, and they all land in one file."},
